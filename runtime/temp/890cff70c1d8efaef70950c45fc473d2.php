<?php /*a:3:{s:81:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\article\recycle.html";i:1540452583;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540453180;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<span class="l">
		<a class="btn btn-primary radius" data-title="添加资讯" data-href="<?php echo url('add'); ?>" onclick="Hui_admin_tab(this)" href="javascript:;">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td><?php echo htmlspecialchars($vo['red_count']); ?></td>
					<td class="td-status">
					<?php if($vo['status'] == '1'): ?>
					...
					<td class="f-14 td-manage">
						...
						<?php if($vo['status'] == '1'): ?>
						<a style="text-decoration:none" onClick="article_stop(this,'<?php echo htmlspecialchars($vo['id']); ?>')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> 
						<?php else: ?>
						
						<a style="text-decoration:none" onClick="article_start(this,'<?php echo htmlspecialchars($vo['id']); ?>')" href="javascript:;" title="上架"><i class='Hui-iconfont'>&#xe68f;</i></a> 
						
						<?php endif; ?>	
						
						<a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑文章','<?php echo url('edit',array('id'=>$vo['id'])); ?>','<?php echo htmlspecialchars($vo['id']); ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
