<?php /*a:3:{s:77:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\message\add.html";i:1539152798;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1538020752;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select valid" id="messages_type" name="messages_type" aria-invalid="false">
		...
		<div class="row cl" style="display:none;" id="demo">
...
<script>
	$(function(){
	    $("#messages_type").click(function() {
	    	
	    var a = $("#messages_type").val();
	    var b = $("#messages_type option:checked").text();
	    var q=parseInt(a);
	    if(q=='2'){
	    	console.log(q);
