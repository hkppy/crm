<?php /*a:3:{s:80:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\message\a_edit.html";i:1539138249;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1538020752;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select valid" id="parent_id" name="pid" aria-invalid="false">
							...
							<option value="<?php echo htmlentities($vo['id']); ?>" <?php if($res['pid'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php  echo str_repeat('|--',$vo['level'])  ?><?php echo htmlentities($vo['name']); ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo htmlentities($res['name']); ?>" placeholder="" id="title" name="title">
			</div>
		</div>
