<?php /*a:4:{s:84:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\setting\system_log.html";i:1540452826;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540782757;s:92:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_column_title.html";i:1538040490;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo htmlspecialchars($vo['note']); ?></td>
				<td><?php echo htmlspecialchars($vo['action']); ?></td>
				<td><?php echo htmlspecialchars($vo['username']); ?></td>
				<td><?php echo htmlspecialchars($vo['ip']); ?></td>
				<td>自定义</td>
				<td><?php echo htmlspecialchars(date('Y-m-d h:i:s',!is_numeric($vo['time'])? strtotime($vo['time']) : $vo['time'])); ?></td>
				<td>
					<a title="删除" href="javascript:;" onclick="system_log_del(this,'<?php echo htmlspecialchars($vo['id']); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			<?php endforeach; ?>
		</tbody>
	</table>
