<?php /*a:3:{s:85:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\rbac\permission_add.html";i:1540452689;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540782757;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select" id="pid" name="pid" onchange="SetSubID(this);">
							...
							<?php if($vo['new_data'] != ''): if(is_array($vo['new_data']) || $vo['new_data'] instanceof \think\Collection || $vo['new_data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['new_data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?>
							   <option value="<?php echo htmlspecialchars($vo['id']); ?>">&nbsp;&nbsp;├ <?php echo htmlspecialchars($v2['title']); ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="admin/index/index" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>style_id：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="style_id" name="style_id">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>字体图标编码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="font_code" name="font_code">
			</div>
		</div>		
