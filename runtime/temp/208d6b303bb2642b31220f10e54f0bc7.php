<?php /*a:3:{s:84:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\seller_group\index.html";i:1540452805;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540782757;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		<a href="javascript:;" onclick="seller_show('添加分组','<?php echo url('add'); ?>')" class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe600;</i> 添加分组</a></span> 
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="text-l">
					 <?php if(is_array($vo['sid_list']) || $vo['sid_list'] instanceof \think\Collection || $vo['sid_list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['sid_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?>
						<?php echo htmlspecialchars($v2['username']); endforeach; endif; else: echo "" ;endif; ?>
				</td>
