<?php /*a:3:{s:79:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\role\role_add.html";i:1540452702;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540453180;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
				...
				<dl class="permission-list">
					...
					<dd>
						<dl class="cl permission-list2">
							<dt>
								<label class="">
									<input type="checkbox" value="<?php echo htmlspecialchars($vo['id']); ?>" name="ids[]" id="user-Character-1-0">
									<?php echo htmlspecialchars($vo['title']); ?></label>
							</dt>
							<dd>
								...
								<label class="">
									<input type="checkbox" value="<?php echo htmlspecialchars($v2['id']); ?>" name="ids[]" id="user-Character-1-0-0">
