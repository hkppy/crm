<?php /*a:3:{s:83:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\customer\show_add.html";i:1540452643;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540453180;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<input type="text" class="input-text" value="<?php echo htmlspecialchars($res2['realname']); ?>"  readonly="readonly" >
						<input type="hidden"  value="<?php echo htmlspecialchars($cid); ?>"  id="cid" name="cid" >
						<?php else: ?>
						...
						<select class="select" size="1" id="cid" name="cid">
							...
							<option value="<?php echo htmlspecialchars($vo['id']); ?>"><?php echo htmlspecialchars($vo['realname']); ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0.00" placeholder="此处由系统自动结算，不用填写" readonly="readonly"  id="pay_amount" name="pay_amount">
			</div>
		</div>
