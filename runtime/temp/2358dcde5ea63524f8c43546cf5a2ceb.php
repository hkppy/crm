<?php /*a:3:{s:79:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\applist\index.html";i:1540452557;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540782757;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="javascript:;" onclick="member_add('添加应用','<?php echo url('add'); ?>','800','600')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加应用</a></span> <span class="r">共有数据：<strong><?php echo htmlspecialchars($count); ?></strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo htmlspecialchars($vo['appid']); ?></td>
				<td><?php echo htmlspecialchars($vo['appsecret']); ?></td>
				<td>http://<?php echo htmlspecialchars(app('request')->server('SERVER_NAME')); ?>/api?id=<?php echo htmlspecialchars($vo['id']); ?></td>
