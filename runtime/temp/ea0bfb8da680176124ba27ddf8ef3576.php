<?php /*a:3:{s:79:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\article\index.html";i:1540452580;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540782757;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="f-14 td-manage">
						...
						<?php if($vo['status'] == '1'): ?>
						<a style="text-decoration:none" onClick="article_stop(this,'<?php echo htmlspecialchars($vo['id']); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6de;</i></a> 
						<?php else: ?>
						
						<a style="text-decoration:none" onClick="article_start(this,'<?php echo htmlspecialchars($vo['id']); ?>')" href="javascript:;" title="恢复"><i class='Hui-iconfont'>&#xe603;</i></a> 
						
						<?php endif; ?>	
						
						<a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑分类','<?php echo url('edit',array('id'=>$vo['id'])); ?>','<?php echo htmlspecialchars($vo['id']); ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
