<?php /*a:3:{s:78:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\article\edit.html";i:1540456787;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540782757;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select valid" id="article_category_id" name="article_category_id" aria-invalid="false">
							...
							<option value="<?php echo htmlspecialchars($vo['id']); ?>"  <?php if($vo['id'] == $res['article_category_id']): ?>selected="selected"<?php endif; ?> ><?php  echo str_repeat('|--',$vo['level'])  ?><?php echo htmlspecialchars($vo['name']); ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo htmlspecialchars($res['title']); ?>" placeholder="" id="title" name="title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo htmlspecialchars($res['sort']); ?>" placeholder="" id="sort" name="sort">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">关键词：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo htmlspecialchars($res['keywords']); ?>" placeholder="" id="keywords" name="keywords">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文章摘要：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="description" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" ><?php echo htmlspecialchars($res['description']); ?></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box">
					<input type="checkbox" id="allowcomments" <?php if($res['allowcomments'] == '1'): ?>checked="checked"<?php endif; ?> name="allowcomments" value="<?php echo htmlspecialchars($res['allowcomments']); ?>">
		...
		<div class="row cl" style="height: 100px;">
			...
			<div class="formControls col-xs-8 col-sm-9" >
			<?php if(!isset($res['imgurl'])): ?>	
			<img src='/../static/style/images/imgup.png' id="input_imgurl" style='width:100px'>
			<?php else: ?>
			<img src='/../static/<?php echo htmlspecialchars($res['imgurl']); ?>' id="input_imgurl" style='width:100px'>
			
			<?php endif; ?>
			
			<input type='hidden' name='imgurl' id="imgurl" value='<?php echo htmlspecialchars($res['imgurl']); ?>'>	
			</div>
		</div>
		<div class="row cl">
