<?php /*a:3:{s:77:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\demo\view\shopping\add.html";i:1539828875;s:78:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\demo\view\public\header.html";i:1539669711;s:83:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\demo\view\public\header_menu.html";i:1539738244;}*/ ?>
<!DOCTYPE html>
<html>
...
<link href="/../static//demo/iconfont/iconfont.css" rel="stylesheet" type="text/css" />
	<body>
		...
		<form action="" method="post" >
			...
			<div class="agent">
				<div class="agent-title">添加 <strong class="realame" ></strong> 客户消费信息</div>
				...
				<div style="height: 50px;font-size: 0.9rem;padding-bottom: 10px;" id="goods1">
				...
				<div style="min-height: 50px;font-size: 0.9rem;padding-bottom: 10px;" id="goods2">
				...
				<div style="min-height: 50px;font-size: 0.9rem;padding-bottom: 10px;" id="address1">
				...
				<div style="min-height: 50px;font-size: 0.9rem;padding-bottom: 10px;" id="address2">
 ...
 <script type="text/javascript">
	...
	$.post(
			"<?php echo url('api/shopping/more'); ?>",
			{id:'<?php echo htmlentities($cid); ?>'},
			function(data){
				console.log(data);
				if(data.status==1){
					$(".realame").text(data.realame);
				}else{
					layer.msg("信息获取失败");
				}
		},'json');
