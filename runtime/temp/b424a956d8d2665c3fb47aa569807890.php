<?php /*a:4:{s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\customer\recycle.html";i:1540452628;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540453180;s:92:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_column_title.html";i:1538040490;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
/*用户-删除*/
function member_del_add(obj,id){
	layer.confirm('确认要恢复删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: "<?php echo url('resysle_delete_add'); ?>",
			data: {'id':id},
			dataType: 'json',
			success: function(data){
				console.log(data);
