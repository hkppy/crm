<?php /*a:3:{s:80:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\article\a_edit.html";i:1540452564;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\header_js.html";i:1540453180;s:82:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\admin\view\public\footer_js.html";i:1538015651;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select valid" id="pid" name="pid" aria-invalid="false">
							...
							<option value="<?php echo htmlspecialchars($vo['id']); ?>" <?php if($vo['id'] == $res['pid']): ?>selected="selected"<?php endif; ?>><?php  echo str_repeat('|--',$vo['level'])  ?><?php echo htmlspecialchars($vo['name']); ?></option>
