<?php /*a:3:{s:79:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\demo\view\customer\index.html";i:1540446176;s:78:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\demo\view\public\header.html";i:1539669711;s:83:"C:\phpStudy2018\PHPTutorial\WWW\tp5.1\application\demo\view\public\header_menu.html";i:1539738244;}*/ ?>
<!DOCTYPE html>
<html>
		...
		$.post(
			...
			function(data){
				if(data.code==1){
					...
					$(".week_count").text(data.week_count);
					$(".month_count").text(data.month_count);
					$(".today_count_money").text(data.today_count_money);
					$(".week_count_money").text(data.week_count_money);
					$(".month_count_money").text(data.month_count_money);
				}else{
					layer.msg("信息获取失败");
				}
		},'json');
            ...
            $.ajax({
                ...
                success: function(data){
                   ...
                   for(var i = pageStart; i < pageEnd; i++){
                    result+="<tr>";
                    result+="<td>"+data.data.lists[i].id+"</td>";
                    result+="<td>"+data.data.lists[i].realname+"</td>";
                    result+="<td>"+data.data.lists[i].lxfs+"："+data.data.lists[i].lxfs_value+"</td>";
                    result+="<td>"+data.data.lists[i].lifa+"</td>";
                    result+="<td>"+data.data.lists[i].birthday+"</td>";
           
                    result+="<td>";
                    result+="<a href='<?php echo url('customer/edit'); ?>?id="+data.data.lists[i].id+"'>修改</a>";
             		result+="<a href='<?php echo url('shopping/more'); ?>?id="+data.data.lists[i].id+"'>更多</a>";
             		result+="<a href='?id="+data.data.lists[i].id+"'>删除</a>";
                    result+="</td>";
